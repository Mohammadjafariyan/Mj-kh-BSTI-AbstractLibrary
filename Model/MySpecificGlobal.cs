...
namespace BigPardakht.Model
{
    public class MySpecificGlobal
    {
        ...
        {
            var plainTextBytes = global::System.Text.Encoding.UTF8.GetBytes(plainText);
            return global::System.Convert.ToBase64String(plainTextBytes);
        }
        public static string Base64Decode(string base64EncodedData)
        {
            var base64EncodedBytes = global::System.Convert.FromBase64String(base64EncodedData);
            return global::System.Text.Encoding.UTF8.GetString(base64EncodedBytes);
        }
        ...
        public static string GenerateUploadFileNameUniqPath()
        {
            ...
            string path = global::System.Web.Hosting.HostingEnvironment.MapPath("~/Content/upload/" + fileName);
            while (File.Exists(path))
            {
                fileName = GenerateName(10);
                path = global::System.Web.Hosting.HostingEnvironment.MapPath("~/Content/upload/" + fileName);
            }
