...
namespace TelegramBotsWebApplication.Service
{
    ...
    { 
        public static string GenerateTokenBySize(int size)
        {
        ...
        public static Guid MD5Hash(string name)
        {
            MD5 md5 = MD5.Create();
            Guid hashed = new Guid(md5.ComputeHash(Encoding.UTF8.GetBytes(name)));
    ...
    {
        public SkipException(string cipherText)
        {
